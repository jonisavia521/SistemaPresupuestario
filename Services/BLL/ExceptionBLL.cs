...
namespace Services.BLL
{
    ...
    {
        private static string dalAssembly ;
        private static string bllAssembly;
        private ILogger _log;
        private NameValueCollection _app;
        public ExceptionBLL(ILogger log, NameValueCollection app)
        {
            _log = log;
            _app = app;
            dalAssembly = app["DALAssembly"];
            bllAssembly = app["BLLAssembly"];
        }
